...
- 🔄 **[G6] Real login + cross-device profile** — agent building 2026-07-11: passkeys primary (@simplewebauthn, new D1 `passkey_credentials` migration, same session model), email-code kept as fallback, root-cause the never-rendering profile UI. NOTE: production D1 migration apply is manual and deliberate.
...
- 🔄 **[H4] Real login + cross-device profile** — agent building 2026-07-11, same plan as G6.
